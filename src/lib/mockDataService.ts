...
const mockStudents: Student[] = [
  ...
  },
  {
    ...
    face_mesh_url: 'https://storage.example.com/meshes/jane_smith_mesh.glb',
    face_pointcloud_url: 'https://storage.example.com/pointclouds/jane_smith_pc.ply',
    face_depthmap_url: 'https://storage.example.com/depthmaps/jane_smith_depth.png',
    face_embedding: 'eyJ0eXBlIjoiRmxvYXQzMkFycmF5IiwiZGF0YSI6Wy0wLjEyMywwLjQ1Niw...}',
    face_embedding_algorithm: 'face-api-v1',
    biometric_consent: true,
    biometric_consent_date: new Date().toISOString(),
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
  ...
  students: {
    insert: async (data: Partial<Student>) => {
      const newStudent: Student = {
        ...
        face_mesh_url: data.face_mesh_url || null,
        face_pointcloud_url: data.face_pointcloud_url || null,
        face_depthmap_url: data.face_depthmap_url || null,
        face_embedding: data.face_embedding || null,
        face_embedding_algorithm: data.face_embedding_algorithm || null,
        biometric_consent: data.biometric_consent || false,
        biometric_consent_date: data.biometric_consent_date || null,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
      };
