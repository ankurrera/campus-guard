  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        // Custom variants for our royal theme
        royal:
          "bg-gradient-royal text-white shadow-elegant hover:shadow-glow transform hover:scale-105 transition-all duration-300",
        glass:
          "glass-card text-foreground hover:bg-card/90 transition-all duration-300",
        success:
